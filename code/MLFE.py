...
class Evaluater(object):
    ...
    def __init__(self, cv=5, stratified=True, n_jobs=1, tasktype="C", evaluatertype="lr", n_estimators=3,
        ...
        if evaluatertype == 'rf':
            if tasktype == "C":
                self.clf = RandomForestClassifier(n_estimators=3,
...
class Env():
    def __init__(self, dataset,feature,binsize=10,opt_type='o1',tasktype="C",evaluatertype='nb',
        ...
        if self.opt_type == 'o1':
            self.origin_feat = self._pretrf_mapper[feature]                             #修改
...
class Model():
    def __init__(self, opt_size, input_size, name, meta=False,update_lr=1e-3,meta_lr=0.001,num_updates=1,maml=True,qsasize=400):
